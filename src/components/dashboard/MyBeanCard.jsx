...
const MyBeanCard = () => {
  return (
    <Card className="xs:max-w-[20%] xl:min-w-[300px] lg:min-w-[240px] min-w-[230px] bg-[#F9FAFB] border-0 px-4 pt-0 pb-2 hover:translate-y-[-5px] transition-all duration-300 ease-in-out cursor-pointer">
